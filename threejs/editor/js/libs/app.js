var APP = {
	...
	Player: function () {
		...
		this.setScene = function ( value ) {
			...
			// {
			// 	if(value.children[i].userData.isOccluder!=null)
			// 	{
			// 		if(value.children[i].userData.isOccluder)
			// 		{
			...
			// 			//   }
			// 			value.children[i].renderOrder = -1e12; // render first
			// 			value.children[i].material = mat;
