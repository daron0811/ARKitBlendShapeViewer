...
namespace UnityChan
{
	...
	public class CameraController : MonoBehaviour
	{
		...
		{
			if(showInstWindow){
				GUI.Box(new Rect(Screen.width -210, Screen.height - 80, 200, 60), "Camera Operations");
				GUI.Label(new Rect(Screen.width -200, Screen.height - 60, 200, 30),"RMB / Alt+LMB: Tumble");
...
//			}
		...
		public void ResetPos()
		{
			...
			focusObj.transform.localEulerAngles = Vector3.zero;
		}
	}
}